...
namespace Modules\Appointment\Filament\RelationManagers\Staff;
...
class StaffAppointmentsRelationManager extends RelationManager
{
    ...
    {
        return AppointmentForm::configure($schema, hidePractitioner: true);
    }
